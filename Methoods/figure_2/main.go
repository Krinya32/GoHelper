...
// Во вторых: в ГО запрещается создавать функции с одинаковыми назнаваниями, а методы разрешены
...
// В ГО разрешено создавать методы с одинаковыми именами в пределах одной структуры. Главное чтобы получатель метода вразных структурах где реализован метод со схожим именем отличался
...
func main() {
	...
	r := Rectangle{10, 20}
	fmt.Println("Call methood", r.Perimeter())
}
