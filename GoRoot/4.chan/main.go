...
// Каналы можно рассматривать, как соединительные трубы, через которые горутины между собой общаются (аналогично так, как вода течет по труба, данные передаются через каналы)
